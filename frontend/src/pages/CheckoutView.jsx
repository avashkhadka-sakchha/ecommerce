...
export default function CheckoutView() {
  const { cart, updateCartQty, removeFromCart, placeOrder, profile } =
    useStore();
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("Submitting checkout with data:", {cart, shippingForm, paymentForm });
  ...
  if (isSuccess && placedOrder) {
    return (
      ...
      >
        ...
        >
          Thank you for shopping with MobileHub! Your order ID is{" "}
          <strong style={{ color: "var(--text)" }}>{placedOrder.id}</strong>. We
        ...
        >
          ...
          <p style={{ fontSize: 14, color: "var(--text)", lineHeight: 1.5 }}>
            {placedOrder.shipping.firstName} {placedOrder.shipping.lastName}
            <br />
            {placedOrder.shipping.street}
            <br />
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center" }}>
          <Link to="/account" className="btn btn-p">
            View Order History
          </Link>
          <Link to="/shop" className="btn btn-s">
            Continue Shopping
          </Link>
        </div>
      </div>
          ...
          >
            <div>
              ...
              <input
                ...
                className="finp"
                style={{
                  borderColor: formErrors.firstName ? "#EF4444" : "transparent",
                }}
              />
            </div>
            <div>
              ...
              <input
                ...
                className="finp"
                style={{
                  borderColor: formErrors.lastName ? "#EF4444" : "transparent",
                }}
              />
            </div>
            <div style={{ gridColumn: "1/-1" }}>
              ...
              <input
                ...
                className="finp"
                style={{
                  borderColor: formErrors.street ? "#EF4444" : "transparent",
                }}
              />
            </div>
            <div>
              ...
              <input
                ...
                className="finp"
                style={{
                  borderColor: formErrors.city ? "#EF4444" : "transparent",
                }}
              />
            </div>
            <div>
              ...
              <input
                ...
                className="finp"
                style={{
                  borderColor: formErrors.province ? "#EF4444" : "transparent",
                }}
              />
            </div>
          </div>
        ...
        >
          ...
          <div
            style={{
              ...
              border: "1.5px solid rgba(36,85,232,.2)",
              borderRadius: 12,
              padding: "14px 16px",
              display: "flex",
              alignItems: "center",
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            <div>
              ...
              <input
                ...
                className="finp"
                style={{
                  borderColor: formErrors.cardNumber
                    ? "#EF4444"
                    : "transparent",
                }}
              />
            ...
            >
              <div>
                ...
                <input
                  ...
                  className="finp"
                  style={{
                    borderColor: formErrors.expiry ? "#EF4444" : "transparent",
                  }}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  className="finp"
                  style={{
                    borderColor: formErrors.cvv ? "#EF4444" : "transparent",
                  }}
                />
              </div>
            </div>
